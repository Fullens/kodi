...
Base = 'D:\Rodrigo\Desktop\kodiluis\Fullens\lista.xml' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.Fullens') #    modificar("el nombre de tu addons")
...
FANART = os.path.join(home, 'fondo.jpg')
